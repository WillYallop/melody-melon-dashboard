...
// Components
// Track Components
import addTrackUrl from '@/components/Campaign/Create/AddTrackUrl'
import spotifyData from '@/components/Campaign/Create/SpotifyData'
import targetGenres from '@/components/Campaign/Create/TargetGenres'
import trackPlacementsSlider from '@/components/Campaign/Create/TrackPlacementsSlider'
import trackReach from '@/components/Campaign/Create/TrackReach'
// Campaign Components
import campaignBreakdown from '@/components/Campaign/Create/CampaignBreakdown'
...
export default {
    ...
    methods: {
        ...
        addGenre(data, index) {
            ...
            // remove
            var genreIndex = this.genreList.indexOf(data)
            this.$store.commit('splicePlaylistGenres', [genreIndex, index])
            // add
        ...
        removeGenre(data, index) {
            ...
            // remove
            var genreIndex = this.genreList.indexOf(data)
            this.$store.commit('spliceSelectedGenres', [genreIndex, index])
            // add
